...
-- -----------------------------------------------
-- SECTION 8: Violations (anti-cheat events)
-- Insert a violation:
-- INSERT INTO Violation (id, sessionId, participantId, violationType, source, payload) VALUES ('v-1', 'ses-1', 'part-1', 'App Backgrounded', 'live', JSON_OBJECT('note','detected'));
-- Per-session violations:
-- SELECT id, participantId, violationType, payload, createdAt FROM Violation WHERE sessionId = 'session-001' ORDER BY createdAt DESC;
